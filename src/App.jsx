...
import { DECKS, VERBS, TF, PASSAGES, EN2DE, REACT_QUIZ, LETTER_IDX, REACT_MODULE_CARDS, REACT_PROF_CARDS, DSA_QUIZ, DSA_MODULE_CARDS, DSA_PROF_CARDS, GLOSSARY, APTITUDE_QUIZ, APTITUDE_MODULE_CARDS, APTITUDE_PROBLEMS, APTITUDE_FORMULAS } from "./data.js";
...
function GlossaryText({ text }) {
  const [active, setActive] = useState(null); // clicked term { term, def }
  if (!text) return null;
