...
export const APTITUDE_QUIZ = [
  ...
  { q: "If 15% of y equals 21% of z, then 12.5% of y is what % of z?", o: ["17.5%", "12.5%", "21%", "15%"], c: "A" },
  { q: "After deducting 20% of a bill, ₹100 is still payable. The original bill was?", o: ["₹125", "₹120", "₹150", "₹80"], c: "A" },
  { q: "A price rises 20% then falls 20%. Net change?", o: ["4% loss", "No change", "4% gain", "20% loss"], c: "A" },
  { q: "Divide 3395 in the ratio 42:32:23. The largest part is?", o: ["1470", "1120", "805", "35"], c: "A" },
  { q: "Sum of three numbers is 285; 1st:2nd = 3:7 and 2nd:3rd = 6:5. The third number is?", o: ["105", "45", "135", "95"], c: "A" },
  { q: "₹8400 is split with A:B = 2:3, B:C = 4:5, C:D = 6:7. A's share?", o: ["₹1280", "₹1600", "₹2400", "₹1050"], c: "A" },
  { q: "Given a:b = 5:7 and c:d = 20:36, then ac:bd =", o: ["25:63", "7:5", "5:9", "100:252"], c: "A" },
  { q: "Three numbers are in ratio ½:⅔:¾ and greatest − smallest = 36. The greatest is?", o: ["108", "96", "72", "120"], c: "A" },
  { q: "Grouped data with modal class 60–80 (f=100), f₁=70, f₂=80, c=20, L=60. The mode is?", o: ["72", "68", "75", "80"], c: "A" },
  { q: "In a pie chart of 1000 workers, a 72° slice represents how many workers?", o: ["200", "133", "72", "360"], c: "A" },
  { q: "Find the 5th term of (2x+3y)⁶.", o: ["4860x²y⁴", "160x²y⁴", "540x²y⁴", "720x⁴y²"], c: "A" },
  { q: "Using binomial expansion, (1.1)⁴ =", o: ["1.4641", "1.331", "1.21", "1.4"], c: "A" },
  { q: "Solve (17−n)!/(14−n)! = 5! for n.", o: ["11", "6", "3", "14"], c: "A" },
  { q: "Solve ⁶P₂ = n · ⁶C₂ for n.", o: ["2", "15", "30", "6"], c: "A" },
  { q: "How many 3-digit numbers can be formed from 0,1,3,5,6 without repetition?", o: ["48", "60", "100", "125"], c: "A" },
  { q: "Using 2,3,4,5,6 without repetition, how many numbers exceed 400?", o: ["276", "240", "156", "120"], c: "A" },
  { q: "How many distinct arrangements of the letters of JEFF are there?", o: ["12", "24", "6", "4"], c: "A" },
  { q: "Arrangements of ALGORITHM with all three vowels together?", o: ["30240", "5040", "151200", "720"], c: "A" },
  { q: "Evaluate (2⁵)^(1/5).", o: ["2", "32", "10", "5"], c: "A" },
  { q: "Which is the smallest: 0.2, (0.2)², 0.22, (0.2)³?", o: ["(0.2)³", "(0.2)²", "0.2", "0.22"], c: "A" },
];
...
export const APTITUDE_PROBLEMS = [
  ...
  /* ───── Added from class notes (full coverage) ───── */
  { topic: "Percentage", q: "15\\% \\text{ of } y = 21\\% \\text{ of } z. \\quad 12.5\\% \\text{ of } y \\text{ is what \\% of } z?", answer: "17.5", accept: ["17.5%"],
    solution: "First relate $y$ and $z$ from the given equality:\n$$\\frac{15}{100}y = \\frac{21}{100}z \\Rightarrow \\frac{y}{z} = \\frac{21}{15} = \\frac{7}{5}$$\nLet the required percentage be $x$, so $12.5\\%$ of $y$ equals $x\\%$ of $z$:\n$$\\frac{12.5}{100}y = \\frac{x}{100}z \\Rightarrow x = 12.5\\times\\frac{y}{z} = 12.5\\times\\frac{7}{5}$$\n$$x = 12.5\\times1.4 = \\boxed{17.5\\%}$$" },
  { topic: "Percentage", q: "\\text{After deducting } 20\\% \\text{ of a bill, ₹100 is still payable. Original bill?}", answer: "125", accept: ["₹125"],
    solution: "Let the original bill be $x$. Deducting $20\\%$ leaves $80\\%$ to pay:\n$$x - \\frac{20}{100}x = 100 \\Rightarrow 0.8x = 100$$\n$$x = \\frac{100}{0.8} = \\frac{1000}{8} = \\boxed{₹125}$$" },
  { topic: "Percentage", q: "\\text{Selling at ₹2880 gives a } 20\\% \\text{ loss. Price for a } 20\\% \\text{ profit?}", answer: "4320", accept: ["₹4320"],
    solution: "Step 1 — find the cost price. A $20\\%$ loss means SP is $80\\%$ of CP:\n$$2880 = \\frac{80}{100}\\,CP \\Rightarrow CP = \\frac{2880\\times100}{80} = ₹3600$$\nStep 2 — selling for a $20\\%$ profit means SP is $120\\%$ of CP:\n$$SP = \\frac{120}{100}\\times3600 = 1.2\\times3600 = \\boxed{₹4320}$$" },
  { topic: "Percentage", q: "\\text{Anil sells 160 pans. 40 sold at } 10\\% \\text{ profit; he wants } 20\\% \\text{ profit overall. Profit \\% on the rest?}", answer: "23.33", accept: ["23.33%", "70/3"],
    solution: "Take each pan's cost as a base of 100, so total cost $= 160\\times100 = 16000$.\nProfit already earned on 40 pans at $10\\%$: $40\\times10 = 400$.\nTarget total profit $= 20\\%$ of $16000 = 3200$.\nProfit still needed $= 3200-400 = 2800$, spread over the remaining $160-40 = 120$ pans.\n$$\\text{Required profit \\%} = \\frac{2800}{120} = \\boxed{23.33\\%}$$" },
  { topic: "Percentage", q: "15\\% \\text{ fail Science, } 25\\% \\text{ fail Maths, } 10\\% \\text{ fail both. \\% passing both?}", answer: "70", accept: ["70%"],
    solution: "Use the union formula for the percentage failing at least one subject:\n$$n(A\\cup B) = n(A)+n(B)-n(A\\cap B) = 15+25-10 = 30\\%$$\nThat $30\\%$ fail at least one subject, so the rest pass both:\n$$100-30 = \\boxed{70\\%}$$" },
  { topic: "Percentage", q: "\\text{A price rises } 20\\% \\text{ then falls } 20\\%. \\text{ Net change \\%?}", answer: "4", accept: ["4%", "-4", "4% loss"],
    solution: "Start at ₹100. Rise $20\\%$: $100+20 = 120$. Fall $20\\%$ of the NEW value: $20\\%$ of $120 = 24$, giving $120-24 = 96$.\nNet: $100\\to96$, a drop of $4$.\n$$\\boxed{4\\%\\text{ loss}}$$\nGeneral rule: $+x\\%$ then $-x\\%$ gives $-\\dfrac{x^2}{100}\\%$; here $\\dfrac{20^2}{100} = 4\\%$." },

  { topic: "Ratio & Proportion", q: "\\text{Divide } 3395 \\text{ in the ratio } 42:32:23.\\ \\text{Largest part?}", answer: "1470",
    solution: "Let the parts be $42x, 32x, 23x$. Their sum is the whole:\n$$42x+32x+23x = 3395 \\Rightarrow 97x = 3395 \\Rightarrow x = 35$$\nSo the parts are:\n$$42(35)=1470,\\quad 32(35)=1120,\\quad 23(35)=805$$\nThe largest is $\\boxed{1470}$ (check: $1470+1120+805 = 3395$)." },
  { topic: "Ratio & Proportion", q: "\\text{Sum of three numbers} = 285.\\ 1\\text{st}:2\\text{nd}=3:7,\\ 2\\text{nd}:3\\text{rd}=6:5.\\ \\text{Third number?}", answer: "105",
    solution: "Combine the ratios by making the middle term match. $A:B=3:7$ and $B:C=6:5$; the LCM of $7$ and $6$ is $42$:\n$$A:B = 18:42,\\qquad B:C = 42:35 \\Rightarrow A:B:C = 18:42:35$$\nLet the common multiplier be $x$:\n$$18x+42x+35x = 285 \\Rightarrow 95x = 285 \\Rightarrow x = 3$$\nThird number $= 35x = 35\\times3 = \\boxed{105}$." },
  { topic: "Ratio & Proportion", q: "\\text{Incomes } 5:6,\\ \\text{spendings } 7:9.\\ \\text{They save ₹4000 \\& ₹3000. Ramesh's income?}", answer: "25000", accept: ["₹25000"],
    solution: "Let the spendings be $7x$ and $9x$. Since income $=$ spending $+$ savings:\n$$\\text{Ramesh} = 7x+4000,\\qquad \\text{Suresh} = 9x+3000$$\nTheir incomes are in ratio $5:6$:\n$$\\frac{7x+4000}{9x+3000} = \\frac{5}{6}$$\nCross-multiply: $6(7x+4000) = 5(9x+3000)$\n$$42x+24000 = 45x+15000 \\Rightarrow 9000 = 3x \\Rightarrow x = 3000$$\nRamesh's income $= 7(3000)+4000 = \\boxed{₹25000}$ (Suresh's $= ₹30000$)." },
  { topic: "Ratio & Proportion", q: "\\text{Storybooks}:\\text{others}=4:3,\\ \\text{storybooks}=1248.\\ \\text{After buying more, ratio}=5:3.\\ \\text{Books bought?}", answer: "312",
    solution: "From the original ratio $4x = 1248 \\Rightarrow x = 312$, so non-storybooks $= 3x = 936$.\nBuying storybooks doesn't change the non-storybooks, so in the new ratio $5:3$ the \"3\" part still equals $936$:\n$$3y = 936 \\Rightarrow y = 312 \\Rightarrow \\text{new storybooks} = 5y = 1560$$\nBooks bought $= 1560-1248 = \\boxed{312}$." },
  { topic: "Ratio & Proportion", q: "\\text{₹8400 split among A,B,C,D with } A{:}B=2{:}3,\\ B{:}C=4{:}5,\\ C{:}D=6{:}7.\\ \\text{A's share?}", answer: "1280", accept: ["₹1280"],
    solution: "Chain the ratios, matching the shared term each time.\n$A{:}B=2{:}3$ and $B{:}C=4{:}5$: make $B$ equal ($\\text{lcm}(3,4)=12$) $\\Rightarrow A{:}B{:}C = 8{:}12{:}15$.\nNow bring in $C{:}D=6{:}7$: make $C$ equal ($\\text{lcm}(15,6)=30$) $\\Rightarrow A{:}B{:}C{:}D = 16{:}24{:}30{:}35$.\nTotal parts $= 16+24+30+35 = 105$.\n$$A = \\frac{16}{105}\\times8400 = 16\\times80 = \\boxed{₹1280}$$" },
  { topic: "Ratio & Proportion", q: "\\text{Price ratio wheat}:\\text{rice}=2:3,\\ \\text{expenditure ratio}=5:4.\\ \\text{Ratio of quantities?}", answer: "15/8", accept: ["15:8", "1.875"],
    solution: "Quantity $= \\dfrac{\\text{expenditure}}{\\text{price}}$. So the quantity ratio is:\n$$\\frac{\\text{wheat qty}}{\\text{rice qty}} = \\frac{5/2}{4/3} = \\frac{5}{2}\\times\\frac{3}{4} = \\frac{15}{8}$$\n$$\\boxed{15:8}$$" },
  { topic: "Ratio & Proportion", q: "\\text{Three numbers in ratio } \\tfrac{1}{2}:\\tfrac{2}{3}:\\tfrac{3}{4}.\\ \\text{Greatest}-\\text{smallest}=36.\\ \\text{Greatest number?}", answer: "108",
    solution: "Clear the fractions by multiplying through by the LCM of denominators, $12$:\n$$\\tfrac{1}{2}:\\tfrac{2}{3}:\\tfrac{3}{4} = 6:8:9$$\nLet the parts be $6x, 8x, 9x$. The greatest minus the smallest:\n$$9x-6x = 3x = 36 \\Rightarrow x = 12$$\nNumbers: $72, 96, 108$. The greatest is $\\boxed{108}$." },
  { topic: "Ratio & Proportion", q: "a:b = 5:7,\\ c:d = 20:36.\\ \\text{Find } ac:bd.", answer: "25/63", accept: ["25:63"],
    solution: "Multiply the ratios termwise:\n$$\\frac{ac}{bd} = \\frac{a}{b}\\times\\frac{c}{d} = \\frac{5}{7}\\times\\frac{20}{36} = \\frac{100}{252}$$\nSimplify (divide by 4):\n$$= \\frac{25}{63} \\Rightarrow \\boxed{25:63}$$" },
  { topic: "Ratio & Proportion", q: "\\text{Equal-ratios theorem with } (a,b,c)=(10,11,21),\\ (p,q,r)=(13,28,11).\\ \\text{Find } k=\\tfrac{a+b+c}{p+q+r}.", answer: "21/26", accept: ["0.8077"],
    solution: "The theorem of equal ratios lets you add numerators and denominators:\n$$k = \\frac{a+b+c}{p+q+r} = \\frac{10+11+21}{13+28+11} = \\frac{42}{52}$$\nSimplify (divide by 2):\n$$\\boxed{\\frac{21}{26}}$$" },

  { topic: "Statistics", q: "\\text{Pie chart of 1000 workers. Construction spans } 72°.\\ \\text{How many work in construction?}", answer: "200",
    solution: "A slice's share of the workers equals its share of the full $360°$:\n$$\\text{workers} = \\frac{\\text{angle}}{360°}\\times\\text{total} = \\frac{72}{360}\\times1000 = 0.2\\times1000 = \\boxed{200}$$\n(An Administration slice of $48°$ would give $\\frac{48}{360}\\times1000 \\approx 133$ workers.)" },
  { topic: "Statistics", q: "\\text{Grouped data (class:f) } 10\\text{-}15{:}7,\\ 15\\text{-}20{:}12,\\ 20\\text{-}25{:}16,\\ 25\\text{-}30{:}10,\\ 30\\text{-}35{:}8,\\ 35\\text{-}40{:}12.\\ \\text{Mean?}", revealOnly: true, answer: "25.27",
    solution: "Use class midpoints $x_i$ in $\\bar{x} = \\dfrac{\\sum f_i x_i}{\\sum f_i}$.\nMidpoints: $12.5, 17.5, 22.5, 27.5, 32.5, 37.5$.\n$f_i x_i$: $87.5,\\ 210,\\ 360,\\ 275,\\ 260,\\ 450$.\n$$\\sum f_i = 65,\\qquad \\sum f_i x_i = 1642.5$$\n$$\\bar{x} = \\frac{1642.5}{65} \\approx \\boxed{25.27}$$" },
  { topic: "Statistics", q: "\\text{Grouped median (class:f) } 50\\text{-}100{:}33,\\ 100\\text{-}150{:}30,\\ 150\\text{-}200{:}90,\\ 200\\text{-}250{:}80,\\ 250\\text{-}300{:}17.", revealOnly: true, answer: "184.44",
    solution: "Total $n = 33+30+90+80+17 = 250$, so $\\tfrac{n}{2} = 125$.\nCumulative frequencies: $33,\\ 63,\\ 153,\\dots$ — $125$ first falls inside class $150\\text{-}200$, the median class.\nSo $L=150,\\ cf=63,\\ f_m=90,\\ c=50$:\n$$\\text{Median} = L + \\left[\\frac{\\frac{n}{2}-cf}{f_m}\\right]c = 150 + \\left[\\frac{125-63}{90}\\right]\\times50$$\n$$= 150 + \\frac{62}{90}\\times50 = 150+34.44 = \\boxed{184.44}$$" },
  { topic: "Statistics", q: "\\text{Grouped mode (class:f) } 0\\text{-}20{:}13,\\ 20\\text{-}40{:}50,\\ 40\\text{-}60{:}70,\\ 60\\text{-}80{:}100,\\ 80\\text{-}100{:}80,\\ 100\\text{-}120{:}17.", revealOnly: true, answer: "72",
    solution: "The modal class has the highest frequency: $60\\text{-}80$ with $f_m=100$. Neighbours $f_1=70$, $f_2=80$; $L=60,\\ c=20$.\n$$\\text{Mode} = L + \\left[\\frac{f_m-f_1}{2f_m-f_1-f_2}\\right]c = 60 + \\left[\\frac{100-70}{200-70-80}\\right]\\times20$$\n$$= 60 + \\frac{30}{50}\\times20 = 60+12 = \\boxed{72}$$" },

  { topic: "Binomial", q: "\\text{Find the 5th term of } (2x+3y)^6.", revealOnly: true, answer: "4860x^2y^4", accept: ["4860x²y⁴"],
    solution: "General term $T_{r+1} = {}^nC_r\\,a^{n-r}b^{r}$ with $a=2x,\\ b=3y,\\ n=6$. The 5th term means $r=4$:\n$$T_5 = {}^6C_4\\,(2x)^{2}(3y)^{4}$$\n${}^6C_4 = 15$, $(2x)^2 = 4x^2$, $(3y)^4 = 81y^4$.\n$$T_5 = 15\\cdot4\\cdot81\\,x^2y^4 = \\boxed{4860\\,x^2y^4}$$" },
  { topic: "Binomial", q: "\\text{Find the 6th term of } \\left(2x-\\tfrac{1}{x^2}\\right)^7.", revealOnly: true, answer: "-84/x^8",
    solution: "Here $a=2x,\\ b=-\\dfrac{1}{x^2},\\ n=7$. The 6th term means $r=5$:\n$$T_6 = {}^7C_5\\,(2x)^{2}\\left(-\\frac{1}{x^2}\\right)^{5}$$\n${}^7C_5 = 21$, $(2x)^2 = 4x^2$, $\\left(-\\frac{1}{x^2}\\right)^5 = -\\frac{1}{x^{10}}$.\n$$T_6 = 21\\cdot4x^2\\cdot\\left(-\\frac{1}{x^{10}}\\right) = \\boxed{-\\frac{84}{x^{8}}}$$" },
  { topic: "Binomial", q: "\\text{Find the middle term(s) of } \\left(3x^2-\\tfrac{1}{2x}\\right)^7.", revealOnly: true, answer: "-2835/8 x^5 and 945/16 x^2",
    solution: "$n=7$ gives $n+1=8$ terms (even), so there are TWO middle terms — the 4th and 5th. Take $a=3x^2,\\ b=-\\dfrac{1}{2x}$.\n4th term ($r=3$):\n$$T_4 = {}^7C_3(3x^2)^4\\left(-\\frac{1}{2x}\\right)^3 = 35\\cdot81x^8\\cdot\\left(-\\frac{1}{8x^3}\\right) = -\\frac{2835}{8}x^5$$\n5th term ($r=4$):\n$$T_5 = {}^7C_4(3x^2)^3\\left(-\\frac{1}{2x}\\right)^4 = 35\\cdot27x^6\\cdot\\frac{1}{16x^4} = \\frac{945}{16}x^2$$\n$$\\boxed{T_4 = -\\tfrac{2835}{8}x^5,\\quad T_5 = \\tfrac{945}{16}x^2}$$" },
  { topic: "Binomial", q: "\\text{Use binomial expansion to evaluate } (1.1)^4.", answer: "1.4641",
    solution: "Write $1.1 = 1+0.1$ and expand $(1+0.1)^4$ with coefficients $1,4,6,4,1$:\n$$1 + 4(0.1) + 6(0.1)^2 + 4(0.1)^3 + (0.1)^4$$\n$$= 1 + 0.4 + 0.06 + 0.004 + 0.0001 = \\boxed{1.4641}$$" },
  { topic: "Binomial", q: "\\text{Use binomial expansion to evaluate } (0.9)^5.", answer: "0.59049",
    solution: "Write $0.9 = 1-0.1$ and expand $(1-0.1)^5$ with coefficients $1,5,10,10,5,1$ (alternating signs):\n$$1 - 5(0.1) + 10(0.1)^2 - 10(0.1)^3 + 5(0.1)^4 - (0.1)^5$$\n$$= 1 - 0.5 + 0.1 - 0.01 + 0.0005 - 0.00001 = \\boxed{0.59049}$$" },

  { topic: "Permutations & Combinations", q: "\\text{Find } n: \\quad \\frac{n}{8!} = \\frac{3}{6!} + \\frac{1}{4!}.", answer: "1848",
    solution: "Multiply both sides by $8!$:\n$$n = 8!\\left(\\frac{3}{6!} + \\frac{1}{4!}\\right)$$\n$\\dfrac{8!}{6!} = 8\\times7 = 56$, so the first term is $56\\times3 = 168$.\n$\\dfrac{8!}{4!} = 8\\times7\\times6\\times5 = 1680$, so the second term is $1680\\times1 = 1680$.\n$$n = 168 + 1680 = \\boxed{1848}$$" },
  { topic: "Permutations & Combinations", q: "\\text{Find } n: \\quad \\frac{(17-n)!}{(14-n)!} = 5!.", answer: "11",
    solution: "Expand the ratio — the $(14-n)!$ cancels three factors:\n$$\\frac{(17-n)(16-n)(15-n)(14-n)!}{(14-n)!} = (17-n)(16-n)(15-n) = 120$$\nWe need three consecutive integers multiplying to $120 = 6\\times5\\times4$. So $17-n = 6$:\n$$\\boxed{n = 11}$$" },
  { topic: "Permutations & Combinations", q: "\\text{Find } n: \\quad {}^{12}P_{n-2} = {}^{11}P_{n-1}.", answer: "10",
    solution: "Write each as factorials: ${}^{12}P_{n-2} = \\dfrac{12!}{(14-n)!}$ and ${}^{11}P_{n-1} = \\dfrac{11!}{(12-n)!}$.\n$$\\frac{12!}{(14-n)!} = \\frac{11!}{(12-n)!}$$\nUse $12! = 12\\cdot11!$ and $(14-n)! = (14-n)(13-n)(12-n)!$:\n$$\\frac{12}{(14-n)(13-n)} = 1 \\Rightarrow (14-n)(13-n) = 12 = 4\\times3$$\nSo $14-n = 4 \\Rightarrow \\boxed{n = 10}$ (check: ${}^{12}P_8 = {}^{11}P_9 = 19958400$)." },
  { topic: "Permutations & Combinations", q: "\\text{Find } n: \\quad {}^6P_2 = n\\cdot{}^6C_2.", answer: "2",
    solution: "Recall ${}^6P_2 = \\dfrac{6!}{4!} = 30$ and ${}^6C_2 = \\dfrac{6!}{2!\\,4!} = 15$.\n$$30 = n\\times15 \\Rightarrow \\boxed{n = 2}$$\n(In general ${}^nP_r = r!\\cdot{}^nC_r$, so here $n = 2! = 2$.)" },
  { topic: "Permutations & Combinations", q: "\\text{Find } n: \\quad {}^{14}C_{2n} : {}^{10}C_{2n-4} = 143 : 10.", answer: "4",
    solution: "Test the natural candidate $n=4$: then $2n=8$ and $2n-4=4$.\n$${}^{14}C_{8} = 3003,\\qquad {}^{10}C_{4} = 210$$\n$$\\frac{3003}{210} = \\frac{143}{10}$$\nThe ratio matches, so $\\boxed{n = 4}$." },
  { topic: "Permutations & Combinations", q: "\\text{Find } n,r: \\quad {}^nP_r = 720,\\ {}^nC_{n-r} = 120.", answer: "10", accept: ["n=10", "n=10, r=3"],
    solution: "Since ${}^nC_{n-r} = {}^nC_r = 120$ and ${}^nP_r = r!\\cdot{}^nC_r$:\n$$720 = r!\\times120 \\Rightarrow r! = 6 \\Rightarrow r = 3$$\nNow ${}^nP_3 = n(n-1)(n-2) = 720 = 10\\times9\\times8$, so $\\boxed{n = 10}$ (with $r=3$)." },
  { topic: "Permutations & Combinations", q: "\\text{Find } n: \\quad {}^{23}C_{3n} = {}^{23}C_{2n+3}.", revealOnly: true, answer: "n = 3 or n = 4",
    solution: "${}^{23}C_x = {}^{23}C_y$ holds when either $x=y$ or $x+y=23$ (since ${}^nC_r={}^nC_{n-r}$).\nCase 1: $3n = 2n+3 \\Rightarrow n = 3$.\nCase 2: $3n + (2n+3) = 23 \\Rightarrow 5n = 20 \\Rightarrow n = 4$.\nBoth are valid: $\\boxed{n = 3 \\text{ or } 4}$." },
  { topic: "Permutations & Combinations", q: "\\text{Find } n: \\quad {}^{21}C_{6n} = {}^{21}C_{n^2+5}.", revealOnly: true, answer: "n = 1, 2 or 5",
    solution: "Using ${}^nC_x={}^nC_y \\Leftrightarrow x=y$ or $x+y=21$.\nDirect ($6n=n^2+5$): $n^2-6n+5=0 \\Rightarrow (n-1)(n-5)=0 \\Rightarrow n=1$ or $5$.\nSymmetry ($6n+n^2+5=21$): $n^2+6n-16=0 \\Rightarrow (n+8)(n-2)=0 \\Rightarrow n=2$.\nValid values: $\\boxed{n = 1,\\ 2,\\ \\text{or } 5}$." },
  { topic: "Permutations & Combinations", q: "\\text{3-digit numbers from } 0,1,3,5,6 \\text{ with no digit repeated?}", answer: "48",
    solution: "Order matters and no repeats. The hundreds digit can't be $0$, so it has $4$ choices ($1,3,5,6$). Then the tens digit can be any of the remaining $4$ (now $0$ is allowed) and the units the remaining $3$:\n$$4\\times4\\times3 = \\boxed{48}$$\n(If repetition were allowed it would be $4\\times5\\times5 = 100$.)" },
  { topic: "Permutations & Combinations", q: "\\text{A lock has 3 rings, each with 5 different letters. Max false trials before it opens?}", answer: "124",
    solution: "Each ring is set independently, so the total number of settings is:\n$$5\\times5\\times5 = 125$$\nExactly one setting opens the lock, so the most wrong attempts before success is:\n$$125-1 = \\boxed{124}$$" },
  { topic: "Permutations & Combinations", q: "\\text{How many numbers from 100 to 999 have 4 in the units place (digits may repeat)?}", answer: "90",
    solution: "Fix the units digit as $4$. The hundreds digit is $1$–$9$ ($9$ choices) and the tens digit is $0$–$9$ ($10$ choices):\n$$9\\times10\\times1 = \\boxed{90}$$\n(If no digit may repeat it becomes $8\\times8\\times1 = 64$.)" },
  { topic: "Permutations & Combinations", q: "\\text{Using } 2,3,4,5,6 \\text{ without repetition, how many numbers exceed 400?}", answer: "276",
    solution: "Numbers with more digits are automatically larger; count by length.\n5-digit: $5! = 120$.  4-digit: $5\\times4\\times3\\times2 = 120$.\n3-digit $>400$: the leading digit must be $4,5,$ or $6$ ($3$ choices), then $4\\times3$ for the rest: $3\\times4\\times3 = 36$.\n$$120+120+36 = \\boxed{276}$$" },
  { topic: "Permutations & Combinations", q: "\\text{How many numbers from 100 to 999 contain the digit 7 exactly once (repetition allowed)?}", answer: "225",
    solution: "Place the single $7$ in each position and forbid $7$ elsewhere.\n$7$ in tens ($\\_\\,7\\,\\_$): hundreds $\\in 1\\text{-}9$ minus $7 = 8$, units $0\\text{-}9$ minus $7 = 9$: $8\\times9 = 72$.\n$7$ in units ($\\_\\,\\_\\,7$): $8\\times9 = 72$.\n$7$ in hundreds ($7\\,\\_\\,\\_$): tens and units each $0\\text{-}9$ minus $7 = 9$: $9\\times9 = 81$.\n$$72+72+81 = \\boxed{225}$$\n(With no repetition the total is $200$.)" },
  { topic: "Permutations & Combinations", q: "\\text{5-digit numbers from } 0,1,2,3,4,5 \\text{ (no repetition) divisible by 5?}", answer: "216",
    solution: "Divisible by $5$ means the last digit is $0$ or $5$ — count each case.\nEnds in $0$: the other four places use the remaining $5$ digits freely: $5\\times4\\times3\\times2 = 120$.\nEnds in $5$: the leading digit can't be $0$, so $4$ choices, then $4\\times3\\times2$: $4\\times4\\times3\\times2 = 96$.\n$$120+96 = \\boxed{216}$$" },
  { topic: "Permutations & Combinations", q: "\\text{Number of 4-letter words from MADHURI (7 distinct letters), no repetition?}", answer: "840",
    solution: "Choose and order $4$ of the $7$ distinct letters — order matters, so it's a permutation:\n$$7\\times6\\times5\\times4 = {}^7P_4 = \\boxed{840}$$\n(If letters could repeat it would be $7^4 = 2401$.)" },
  { topic: "Permutations & Combinations", q: "\\text{Arrangements of ALGORITHM: (a) vowels together, (b) no two vowels together, (c) O first \\& T last?}", revealOnly: true, answer: "30240; 151200; 5040",
    solution: "ALGORITHM has $9$ distinct letters: $3$ vowels (A, O, I) and $6$ consonants.\n(a) Vowels together — glue the $3$ vowels into one block ($7$ units) and arrange the vowels inside:\n$$7!\\times3! = 5040\\times6 = 30240$$\n(b) No two vowels together — arrange the $6$ consonants ($6! = 720$), creating $7$ gaps, then place $3$ vowels in distinct gaps (${}^7P_3 = 210$):\n$$720\\times210 = 151200$$\n(c) O first and T last — fix those two; arrange the other $7$ letters: $7! = 5040$.\n$$\\boxed{30240,\\ 151200,\\ 5040}$$" },
  { topic: "Permutations & Combinations", q: "\\text{Arrangements of SOLAPUR with consonants \\& vowels placed alternately?}", answer: "144",
    solution: "SOLAPUR has $7$ letters: $4$ consonants (S, L, P, R) and $3$ vowels (O, A, U). Alternating across $7$ slots forces $C\\,V\\,C\\,V\\,C\\,V\\,C$ — consonants in the $4$ odd slots, vowels in the $3$ even slots.\n$$4!\\times3! = 24\\times6 = \\boxed{144}$$" },
  { topic: "Permutations & Combinations", q: "\\text{How many arrangements of the letters of JEFF?}", answer: "12",
    solution: "JEFF has $4$ letters with F repeated twice. Divide total arrangements by the factorial of the repeat count:\n$$\\frac{4!}{2!} = \\frac{24}{2} = \\boxed{12}$$" },

  { topic: "Approximation & Indices", q: "\\text{Evaluate } \\left(2^5\\right)^{1/5}.", answer: "2",
    solution: "Multiply the exponents (a power raised to a power):\n$$\\left(2^5\\right)^{1/5} = 2^{\\,5\\times\\frac{1}{5}} = 2^1 = \\boxed{2}$$" },
  { topic: "Approximation & Indices", q: "\\text{Evaluate } \\sqrt[3]{\\sqrt{3^3}}.", answer: "√3", accept: ["sqrt3", "1.732", "3^(1/2)"],
    solution: "Convert the roots to exponents. $\\sqrt{3^3} = (3^3)^{1/2} = 3^{3/2}$, then the cube root:\n$$\\left(3^{3/2}\\right)^{1/3} = 3^{\\frac{3}{2}\\times\\frac{1}{3}} = 3^{1/2} = \\boxed{\\sqrt{3}} \\approx 1.732$$" },
  { topic: "Approximation & Indices", q: "\\text{Evaluate the recurring decimal } 17.4\\overline{99}.", answer: "17.5",
    solution: "The digit $4$ does not repeat; the block $99$ does. For a mixed recurring decimal subtract the non-repeating part and put it over $9$s (for repeats) and $0$s (for the tail):\n$$0.4\\overline{99} = \\frac{499-4}{990} = \\frac{495}{990} = \\frac{1}{2}$$\n$$17.4\\overline{99} = 17 + \\tfrac{1}{2} = \\boxed{17.5}$$" },
  { topic: "Approximation & Indices", q: "\\text{Which is largest: } \\tfrac{5}{8},\\ \\tfrac{3}{7},\\ \\tfrac{2}{9},\\ \\tfrac{4}{5}?", answer: "4/5", accept: ["0.8"],
    solution: "Convert to decimals to compare:\n$$\\tfrac{5}{8}=0.625,\\ \\tfrac{3}{7}\\approx0.429,\\ \\tfrac{2}{9}\\approx0.222,\\ \\tfrac{4}{5}=0.8$$\nThe largest is $\\boxed{\\tfrac{4}{5}}$." },
  { topic: "Approximation & Indices", q: "\\text{Which is smallest: } 0.2,\\ (0.2)^2,\\ 0.22,\\ (0.2)^3?", answer: "0.008", accept: ["(0.2)^3", "0.2^3"],
    solution: "Raising a number between $0$ and $1$ to a higher power makes it smaller:\n$$0.2 = 0.2,\\ (0.2)^2 = 0.04,\\ 0.22 = 0.22,\\ (0.2)^3 = 0.008$$\nThe smallest is $(0.2)^3 = \\boxed{0.008}$." },
  { topic: "Approximation & Indices", q: "\\text{Put in ascending order: } \\tfrac{6}{7},\\ \\tfrac{8}{9},\\ \\tfrac{1}{8},\\ \\tfrac{9}{10}.", revealOnly: true, answer: "1/8, 6/7, 8/9, 9/10",
    solution: "As decimals: $\\tfrac{6}{7}\\approx0.857,\\ \\tfrac{8}{9}\\approx0.889,\\ \\tfrac{1}{8}=0.125,\\ \\tfrac{9}{10}=0.9$.\nAscending:\n$$\\boxed{\\tfrac{1}{8} < \\tfrac{6}{7} < \\tfrac{8}{9} < \\tfrac{9}{10}}$$" },
  { topic: "Approximation & Indices", q: "\\text{Simplify } 8 - 8\\times\\dfrac{2\\frac{1}{5} - 1\\frac{2}{7}}{\\,2 - \\frac{1}{\\,6-\\frac{1}{6}\\,}\\,}.", revealOnly: true, answer: "4",
    solution: "Work the small pieces first. Numerator: $2\\tfrac{1}{5}-1\\tfrac{2}{7} = \\tfrac{11}{5}-\\tfrac{9}{7} = \\tfrac{77-45}{35} = \\tfrac{32}{35}$.\nInner denominator: $6-\\tfrac{1}{6} = \\tfrac{35}{6}$, so $\\tfrac{1}{35/6} = \\tfrac{6}{35}$, giving $2-\\tfrac{6}{35} = \\tfrac{64}{35}$.\nThe big fraction: $\\dfrac{32/35}{64/35} = \\dfrac{32}{64} = \\tfrac{1}{2}$.\n$$8 - 8\\times\\tfrac{1}{2} = 8-4 = \\boxed{4}$$" },

  { topic: "Linear Equations", q: "\\text{Instead of multiplying } x \\text{ by } \\tfrac{3}{4} \\text{ it was divided by } \\tfrac{3}{4}; \\text{ the answers differ by 14. Find } x.", answer: "24",
    solution: "Dividing by $\\tfrac{3}{4}$ is multiplying by $\\tfrac{4}{3}$. The two results are $\\tfrac{4x}{3}$ and $\\tfrac{3x}{4}$, differing by $14$:\n$$\\frac{4x}{3} - \\frac{3x}{4} = 14 \\Rightarrow \\frac{16x-9x}{12} = 14$$\n$$\\frac{7x}{12} = 14 \\Rightarrow 7x = 168 \\Rightarrow x = \\boxed{24}$$" },
  { topic: "Linear Equations", q: "\\text{Bags A,B: moving 10 from B to A swaps their counts; moving 10 from A to B makes B twice A. Pebbles in A?}", answer: "50",
    solution: "Moving $10$ from B to A interchanges the amounts — that happens only when they already differ by $20$:\n$$B - A = 20 \\quad(1)$$\nMoving $10$ the other way: $B+10 = 2(A-10) \\Rightarrow 2A - B = 30 \\quad(2)$.\nAdd (1) and (2): $A = 50$, then $B = 70$.\n$$\\boxed{A = 50,\\ B = 70}$$" },
  { topic: "Linear Equations", q: "\\text{Each of } x \\text{ members gives } 2x \\text{ \\& govt gives } x. \\text{ Had each given } x \\text{ \\& govt } 2x, \\text{ they'd have ₹210 less. Members?}", answer: "15",
